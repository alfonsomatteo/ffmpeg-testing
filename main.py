...
async def process_podcast(stacchetto: UploadFile = File(...), background_music: UploadFile = File(...), files: list[UploadFile] = File(...)):
    ...
    # Unione dei file audio con la musica di sottofondo
...
# Log finale per confermare che il server è avviato
print("Server FastAPI avviato e pronto per ricevere richieste sulla porta 8000")
